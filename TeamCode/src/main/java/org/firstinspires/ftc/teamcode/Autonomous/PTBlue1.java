    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if(vuMark == RelicRecoveryVuMark.LEFT){
                if(redJewel=true){
                    moveBackward(.4, 825); //go a little less than necessary
                }
                else {
                    moveBackward(.4, 950); //go a little less than necessary
                }
            }
                ...
                if(redJewel=true){
                    ...
                    moveBackward(.4, 800); //go a little less than necessary
                }
            }
            else {
                if (redJewel = true) {
                    moveBackward(.4, 1050); //go a little more than necessary
                }
                else{
                    moveBackward(.4, 1000); //go a little more than necessary
                }
            }
